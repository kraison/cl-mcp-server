...
(defparameter *clhs-page-alist*
  '(
    ...
    ("subseq-out-of-bounds:is-an-error" . "iss332.htm")
    ("subsetp" . "f_subset.htm")
    ("subsetting-position:none" . "iss333.htm")
    ("subst" . "f_substc.htm")
    ...
    ("subtypep-environment:add-arg" . "iss334.htm")
    ("subtypep-too-vague:clarify-more" . "iss335.htm")
    ("svref" . "f_svref.htm")
    ("sxhash" . "f_sxhash.htm")
    ("sxhash-definition:similar-for-sxhash" . "iss336.htm")
    ("symbol" . "t_symbol.htm")
    ("symbol-function" . "f_symb_1.htm")
    ("symbol-macrolet" . "s_symbol.htm")
    ("symbol-macrolet-declare:allow" . "iss337.htm")
    ("symbol-macrolet-semantics:special-form" . "iss338.htm")
    ("symbol-macrolet-type-declaration:no" . "iss339.htm")
    ("symbol-macros-and-proclaimed-specials:signals-an-error" . "iss340.htm")
    ("symbol-name" . "f_symb_2.htm")
    ("symbol-package" . "f_symb_3.htm")
    ("symbol-plist" . "f_symb_4.htm")
    ("symbol-print-escape-behavior:clarify" . "iss341.htm")
    ("symbol-value" . "f_symb_5.htm")
    ("symbolp" . "f_symbol.htm")
    ("synonym-stream" . "t_syn_st.htm")
    ("synonym-stream-symbol" . "f_syn_st.htm")
    ("syntactic-environment-access:retracted-mar91" . "iss342.htm")
    ("t" . "a_t.htm")
    ("tagbody" . "s_tagbod.htm")
    ("tagbody-tag-expansion:no" . "iss343.htm")
    ("tailp" . "f_ldiffc.htm")
    ("tailp-nil:t" . "iss344.htm")
    ("tan" . "f_sin_c.htm")
    ("tanh" . "f_sinh_.htm")
    ("tenth" . "f_firstc.htm")
    ("terpri" . "f_terpri.htm")
    ("test-not-if-not:flush-all" . "iss345.htm")
    ("the" . "s_the.htm")
    ("the-ambiguity:for-declaration" . "iss346.htm")
    ("the-values:return-number-received" . "iss347.htm")
    ("third" . "f_firstc.htm")
    ("throw" . "s_throw.htm")
    ("time" . "m_time.htm")
    ("time-zone-non-integer:allow" . "iss348.htm")
    ("trace" . "m_tracec.htm")
    ...
    ("type" . "a_type.htm")
    ("type-declaration-abbreviation:allow-all" . "iss349.htm")
    ("type-error" . "e_tp_err.htm")
    ("type-error-datum" . "f_tp_err.htm")
    ("type-error-expected-type" . "f_tp_err.htm")
    ("type-of" . "f_tp_of.htm")
    ("type-of-and-predefined-classes:type-of-handles-floats" . "iss350.htm")
    ("type-of-and-predefined-classes:unify-and-extend" . "iss351.htm")
    ("type-of-underconstrained:add-constraints" . "iss352.htm")
    ("type-specifier-abbreviation:x3j13-jun90-guess" . "iss353.htm")
    ...
    ("undefined-variables-and-functions:compromise" . "iss354.htm")
    ("unexport" . "f_unexpo.htm")
    ("uninitialized-elements:consequences-undefined" . "iss355.htm")
    ("unintern" . "f_uninte.htm")
    ("union" . "f_unionc.htm")
    ("unless" . "m_when_.htm")
    ("unread-char" . "f_unrd_c.htm")
    ("unread-char-after-peek-char:dont-allow" . "iss356.htm")
    ("unsigned-byte" . "t_unsgn_.htm")
    ("unsolicited-messages:not-to-system-user-streams" . "iss357.htm")
    ...
    ("variable-list-asymmetry:symmetrize" . "iss358.htm")
    ("vector" . "a_vector.htm")
    ...
    ("with-added-methods:delete" . "iss359.htm")
    ("with-compilation-unit" . "m_w_comp.htm")
    ("with-compilation-unit:new-macro" . "iss360.htm")
    ...
    ("with-open-file-does-not-exist:stream-is-nil" . "iss361.htm")
    ("with-open-file-setq:explicitly-vague" . "iss362.htm")
    ("with-open-file-stream-extent:dynamic-extent" . "iss363.htm")
    ("with-open-stream" . "m_w_op_1.htm")
    ("with-output-to-string" . "m_w_out_.htm")
    ("with-output-to-string-append-style:vector-push-extend" . "iss364.htm")
    ...
    ("with-standard-io-syntax-readtable:x3j13-mar-91" . "iss365.htm")
    ("write" . "f_wr_pr.htm")
